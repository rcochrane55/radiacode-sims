...
// define position and solids for reflector
  ...
  std::ifstream file("/home/dzybba/Desktop/geant4sims/radiacode-sims-optical/emission_spectrum_data.csv");
  ...
  std::ifstream absorptionFile("/home/dzybba/Desktop/geant4sims/radiacode-sims-optical/absorption_length_data.csv");
...
for (const auto& point : absorptionData)
{
  ...
  new G4LogicalBorderSurface("SiPMSurface", scintillatorPV, siPMPV, SiPMSurface);
